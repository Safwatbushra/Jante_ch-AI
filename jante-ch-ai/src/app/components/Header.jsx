  ...
  return (
    <header className={`header ${isScrolled ? 'scrolled' : ''}`}>
      <div className="header-container">
        <div className="logo">
          <svg className="pinterest-icon" height="24" width="24" viewBox="0 0 24 24" aria-hidden="true" aria-label="" role="img">
        ...
        <div className="search-container">
          <div className="search-icon">
            <svg height="16" width="16" viewBox="0 0 24 24" aria-label="Search icon" role="img">
        ...
        <div className="user-actions">
          ...
          <button className="icon-button messages">
            <svg height="24" width="24" viewBox="0 0 24 24" aria-hidden="true" aria-label="" role="img">
